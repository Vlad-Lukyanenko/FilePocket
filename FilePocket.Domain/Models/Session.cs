namespace FilePocket.Domain.Models
{
    public class Session
    {
        ...
        public Session(Guid userId, Guid storageId, FileChunkedUploadModel fileUpload) : this(userId, storageId, fileUpload, DEFAULT_TIMEOUT) { }
        ...
        public Session(Guid userId, Guid storageId, FileChunkedUploadModel fileUpload, long timeout)
        {
            Id = Guid.NewGuid();
