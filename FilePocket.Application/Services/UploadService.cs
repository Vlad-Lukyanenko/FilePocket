...
using FilePocket.Shared.Helpers;
...
namespace FilePocket.Application.Services
{
    public class UploadService(IConfiguration configuration) : IUploadService
    {
        ...
        public Session CreateSession(Guid userId, Guid storageId, string fileName, long fileSize)
        {
            ...
            var session = new Session(userId, storageId, new FileChunkedUploadModel(fileSize, fileName, chankSize));
