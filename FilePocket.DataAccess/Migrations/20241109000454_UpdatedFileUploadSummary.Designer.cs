...
namespace FilePocket.DataAccess.Migrations
{
    ...
    [Migration("20241109000454_UpdatedFileUploadSummary")]
    partial class UpdatedFileUploadSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilePocket.Domain.Entities.FileUploadSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FilePocket.Domain.Entities.Storage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FilePocket.Domain.Entities.FileUploadSummary", b =>
                {
                    b.HasOne("FilePocket.Domain.Entities.Storage", "Storage")
                        .WithMany("FileUploadSummaries")
            ...
            modelBuilder.Entity("FilePocket.Domain.Entities.Storage", b =>
                {
                    b.Navigation("FileUploadSummaries");
                });
