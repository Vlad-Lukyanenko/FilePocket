...
public class GetAllFoldersEndpoint : BaseEndpointWithoutRequest<List<GetAllFoldersResponse>>
{
    ...
    {
        Verbs(Http.Get);
        Routes("api/pockets/{pocketId:guid}/{isSoftDeleted:bool}/folders");
    }
    ...
    public override async Task HandleAsync(CancellationToken cancellationToken)
    {
        ...
        var folders = await _service.FolderService.GetAllAsync(UserId, PocketId, null, folderTypes, isSoftDeleted);
